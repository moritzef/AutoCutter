package main.java.decoders.processing.jflac.util;
...
import main.java.decoders.processing.jflac.ChannelData;
import main.java.decoders.processing.jflac.Constants;
...
public class WavWriter {
     ...
     *
     * @throws java.io.IOException Thrown if error writing to output string.
     */
     ...
     * @throws java.io.IOException Thrown if error writing to output channel
     */
     ...
     * @throws java.io.IOException Thrown if error writing to file
     */
