...
public class Analyser implements FrameListener {
     ...
     * @see main.java.decoders.processing.jflac.FrameListener#processMetadata(main.java.org.kc7bfi.jflac.metadata.MetadataBase)
     */
     ...
     * @see main.java.decoders.processing.jflac.FrameListener#processFrame(main.java.decoders.processing.jflac.frame.Frame)
     */
