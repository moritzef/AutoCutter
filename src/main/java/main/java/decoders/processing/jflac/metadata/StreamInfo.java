package main.java.decoders.processing.jflac.metadata;
...
public class StreamInfo extends Metadata {
     ...
     * @throws java.io.IOException Thrown if error reading from InputBitStream
     */
     ...
     * @throws java.io.IOException Thrown if error writing data
     */
