package main.java.decoders.processing.jflac.io;
...
public class BitInputStream {
     ...
     * @throws java.io.IOException Thrown if error reading from input stream
     */
     ...
     *
     * @return The bit
     * @throws java.io.IOException Thrown if error reading input stream
     */
