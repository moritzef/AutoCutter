...
import main.java.decoders.processing.jflac.LPCPredictor;
import main.java.decoders.processing.jflac.io.BitInputStream;
import main.java.decoders.processing.jflac.util.BitMath;
...
public class ChannelLPC extends Channel {
     ...
     * @throws java.io.IOException Thrown if error reading from the InputBitStream
     */
