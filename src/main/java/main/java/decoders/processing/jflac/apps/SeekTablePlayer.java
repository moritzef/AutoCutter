package main.java.decoders.processing.jflac.apps;
...
import main.java.decoders.processing.jflac.FLACDecoder;
import main.java.decoders.processing.jflac.FrameListener;
import main.java.decoders.processing.jflac.PCMProcessor;
import main.java.decoders.processing.jflac.frame.Frame;
import main.java.decoders.processing.jflac.io.RandomFileInputStream;
import main.java.decoders.processing.jflac.metadata.Metadata;
import main.java.decoders.processing.jflac.metadata.SeekPoint;
import main.java.decoders.processing.jflac.metadata.SeekTable;
import main.java.decoders.processing.jflac.metadata.StreamInfo;
import main.java.decoders.processing.jflac.util.ByteData;
...
public class SeekTablePlayer implements PCMProcessor, FrameListener {
     ...
     * @see main.java.decoders.processing.jflac.PCMProcessor#processStreamInfo(main.java.decoders.processing.jflac.metadata.StreamInfo)
     */
     ...
     * @see main.java.decoders.processing.jflac.PCMProcessor#processPCM(main.java.org.kc7bfi.jflac.util.ByteSpace)
     */
     ...
     * @see main.java.decoders.processing.jflac.FrameListener#processError(String)
     */
