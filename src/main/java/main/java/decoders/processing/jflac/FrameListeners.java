...
class FrameListeners implements FrameListener {
     ...
     * @see FrameListener#processMetadata(main.java.org.kc7bfi.jflac.metadata.MetadataBase)
     */
     ...
     * @see FrameListener#processFrame(main.java.decoders.processing.jflac.frame.Frame)
     */
