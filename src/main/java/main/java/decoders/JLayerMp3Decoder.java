...
import main.java.decoders.processing.jlayer.*;
 ...
 */
public class JLayerMp3Decoder implements main.java.decoders.Decoder {

    /**
     * JLayer decoder class
     */
    private main.java.decoders.processing.jlayer.Decoder decoder;
    /**
     * MP3 input stream
     */
    ...
    public JLayerMp3Decoder(InputStream stream) {
        ...
        decoder = new main.java.decoders.processing.jlayer.Decoder();
